...
impl Calculator {
    ...
    pub fn addition(&self) -> Option<i64> {
        // Implement addition of calculator's x and y values.
        ...
        self.x.checked_add(self.y).map(|sum| sum)
    }
    /// Subtraction with Underflow/Overflow Resilience
    pub fn subtraction(&self) -> Option<i64> {
        // Implement subtraction of calculator's x and y values.
        // Return None in case of under/overflow.
        self.x.checked_sub(self.y).map(|sum| sum)
    }
    /// Multiplication with Underflow/Overflow Resilience
    pub fn multiplication(&self) -> Option<i64> {
        // Implement multiplication of calculator's x and y values.
        // Return None in case of under/overflow.
        self.x.checked_mul(self.y).map(|sum| sum)
    }
    /// Division with Underflow/Overflow Resilience
    pub fn division(&self) -> Option<i64> {
        // Implement division of calculator's x and y values.
        // Return None in case of division by zero.
        self.x.checked_div(self.y).map(|sum| sum)
    }
}
impl Rectangle {
    /// Constructor
    ...
    pub fn set_a(&mut self, a: &f64) -> Result<(), &'static str> {
        // Implement the setter method and set the field `a` of the Rectangle struct
        ...
        if *a >= 0.0 {
            ...
            Err("Rectangle side a must be greater or equal to zero!")
        }
    }
    /// Set side b
    pub fn set_b(&mut self, b: &f64) -> Result<(), &'static str> {
        // Implement the setter method and set the field `b` of the Rectangle struct
        // Notice that the fields a and b of Rectangle struct are private and can be access only by Rectangles methods
        // If the parameter is greater or equal to zero, update it and return Ok(())
        // otherwise return an Err (similar to try_new method)
        if *b >= 0.0 {
            ...
            Err("Rectangle side b must be greater or equal to zero!")
        }
    }
    /// Get for A
...
impl Circle {
    ...
    pub fn set_r(&mut self, r: &f64) -> Result<(), &'static str> {
        // Create and implement the setter method called `set_r` and set the field `r` of the Circle struct
        // If the parameter is greater or equal to zero, update it and return Ok(())
        // otherwise return an Err (similar to try_new method)
        if *r >= 0.0 {
            self.r = *r;
...
// Implement the Shape trait and its methods for the Circle struct
